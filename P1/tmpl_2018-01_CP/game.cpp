...
void Game::Init()
{
	...
	/////////////////////////////////////////////////////////////////////////
	RTLight* pLight = RTLight::createPointLight( vec3( 1.0f, 1.0f, 1.0f ), 500.0f, vec3( 20.0f, -20.0f, -50.0f ) );
	scene.addLight( pLight );

	scene.addObject( new RTPlane( vec3( 0.1f, 3.0f, 0.0f ), vec3( 0.0f, -1.0f, 0.0f ), whiteMaterial ) );
